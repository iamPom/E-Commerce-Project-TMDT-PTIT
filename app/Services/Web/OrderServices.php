...
class OrderServices extends BaseService
{
    ...
    public function create($data)
    {
        ...
        if ($data['payment'] == "1") {
            ...
            $vnp_TmnCode = "W1B32QI3"; //Mã website tại VNPAY 
            $vnp_HashSecret = "MCHJPGYONBDQLAQTQRNAFIVUFLSENBTG"; //Chuỗi bí mật

            $vnp_TxnRef = rand(100, 1000); //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
