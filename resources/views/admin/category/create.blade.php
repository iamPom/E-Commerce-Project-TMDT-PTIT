    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Thêm mới danh mục</h5>
                        <!-- General Form Elements -->
                        {{-- 'name','description','image','slug' --}}
                        @include('admin.layouts.includes.message')
                        <form action="{{route('admin.category.store')}}" enctype="multipart/form-data" id="myForm" method="POST">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="slug" id="slug"
                                        data-msg="Slug is required" value="{{ old('slug') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
