    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Thêm mới sản phẩm</h5>
                        ...
                        <form action="{{route('admin.product.store')}}" enctype="multipart/form-data" id="myForm" method="POST">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" id="name"
                                        data-msg="Name Category is required" value="{{ old('name') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="description" id="description"
                                        data-msg="Description is required" value="{{ old('description') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="size" id="size"
                                        data-msg="Slug is required" value="{{ old('size') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="price" id="price"
                                        data-msg="Slug is required" value="{{ old('price') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="quantity" id="quantity"
                                        data-msg="quantity is required" value="{{ old('quantity') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="note_use" id="note_use"
                                        data-msg="Slug is required" value="{{ old('note_use') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
