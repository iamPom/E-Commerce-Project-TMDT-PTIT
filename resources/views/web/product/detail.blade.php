...
@section('content')
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Product {{ $product->name }} Detail</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="">Home</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">Product {{ $product->name }} Detail</p>
            </div>
        </div>
    </div>
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="mb-4">All review for "{{ $product->name }}"</h4>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-0">
                                    <button type="button" value="Leave Your Review" data-id="{{ $product->id }}"
                                        ...
                                        onclick="setReviewData()">Leave Your
                                        Review</button>
                                </div>
                            </div>
                        </div>
