...
Route::get('auth/google/callback',[App\Http\Controllers\Auth\LoginController::class, 'handleGoogleCallback'])->name('google-login');
...
Route::middleware(['auth'])->group(function () {
    // các định tuyến bị bảo vệ bởi middleware 'auth' nằm trong đây
    ...
    Route::get('/checkout', [App\Http\Controllers\Web\CheckOutController::class , 'index'])->name('checkout');
    // Route::post('/checkout/vnpay', [App\Http\Controllers\Web\OrderController::class , 'vnPay'])->name('checkout.vnpay');
